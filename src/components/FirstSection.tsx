        ...
        <div className="relative transparent overflow-hidden sm:h-200 md:h-200 lg:h-dvh h-100 w-dvw  self-center-safe align-middle flex flex-col justify-center items-center ">
            <div className="relative z-10 p-10 text-center">
                ...
                <div className="flex flex-row justify-center">
                    <button className="rounded-xl font-bold  hover:bg-blue-700 bg-blue-500 p-3"><Link href="/men">SHOP MEN</Link></button>
                    <button className="rounded-xl font-bold bg-gray-400 hover:bg-gray-700 p-3  mx-5"><Link href="/women">SHOP WOMEN</Link></button>
                </div>
            </div>
